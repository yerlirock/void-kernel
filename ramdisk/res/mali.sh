...
if [[ $(sha1sum /system/lib/egl/libGLESv2_mali.so | awk '{print $1}') != $(sha1sum /data/arter97_secondrom/system/lib/egl/libGLESv2_mali.so | awk '{print $1}') ]]; then
...
if [[ $(sha1sum /system/lib/egl/libGLESv1_CM_mali.so | awk '{print $1}') != $(sha1sum /data/arter97_secondrom/system/lib/egl/libGLESv1_CM_mali.so | awk '{print $1}') ]]; then
...
if [[ $(sha1sum /system/lib/egl/libEGL_mali.so | awk '{print $1}') != $(sha1sum /data/arter97_secondrom/system/lib/egl/libEGL_mali.so | awk '{print $1}') ]]; then
...
if [[ $(sha1sum /system/lib/libMali.so | awk '{print $1}') != $(sha1sum /data/arter97_secondrom/system/lib/libMali.so | awk '{print $1}') ]]; then
...
if [[ $(sha1sum /system/lib/libUMP.so | awk '{print $1}') != $(sha1sum /data/arter97_secondrom/system/lib/libUMP.so | awk '{print $1}') ]]; then
